...
CONFIG_VARIABLE (bool, bypass_plugins_while_recording, "bypass-plugins-while-recording", false)
CONFIG_VARIABLE (bool, bypass_aux_sends_while_recording, "bypass-aux-sends-while-recording", false)
